...
document.getElementById('loveIn').innerHTML = '<a href="#"><img src="assets/open-box.png" alt="HTML tutorial" style="width:42px;height:42px;"></a><p id="ket">Touch the SURPRISE!</p>';
